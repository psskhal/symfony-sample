 ...
 * @version   SVN: $Id: ckWsdlDefinitions.class.php 10862 2008-08-13 16:31:02Z chrisk $
 */
...
class ckWsdlDefinitions implements ckDOMSerializable
{
  ...
  public function serialize(DOMDocument $document)
  {
    ...
    {
      if($type->getIsElement()) $schema_node->appendChild($type->serializeElement($document));
